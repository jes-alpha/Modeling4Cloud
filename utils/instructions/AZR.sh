...
pings=(
    "AZR ./keys/jBianco 40.113.70.169 104.214.219.149 north-eu west-eu 1"
    )
...
iperfs=("AZR ./keys/jBianco 40.113.70.169 ./keys/jBianco 104.214.219.149 north-eu west-eu 80 1 14 1 1")
...
qperfs=("AZR ./keys/jBianco 40.113.70.169 ./keys/jBianco 104.214.219.149 north-eu west-eu 8080 1")
